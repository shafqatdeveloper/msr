...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center">
      ...
      {/* Mobiel Menu */}
      <div className="pt-3 border-b-[0.2px] border-b-gray-800 pb-2.5 flex items-center justify-between w-full px-6">
        <Link href={"/"}>
          <h1>&lt;/&gt;</h1>
        </Link>
        <Link href={"/"} className="flex items-center gap-2">
      ...
      {isNavOpen ? (
        <div className="w-full  fixed bg-[#101010] top-0 h-screen transition-all duration-700">
          {/* Navbar Inside Opened Navbar */}
          <div className=" flex pt-3 border-b-[0.2px] border-b-gray-800 pb-2.5 items-center justify-between w-full px-6">
            <Link href={"/"}>
              <h1>&lt;/&gt;</h1>
            </Link>
            <Link href={"/"} className="flex items-center gap-2">
